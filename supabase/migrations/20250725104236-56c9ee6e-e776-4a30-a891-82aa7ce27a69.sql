...
DROP POLICY IF EXISTS "Users can view group memberships they're part of" ON public.savings_group_members;
...
DROP POLICY IF EXISTS "Group admins can update members" ON public.savings_group_members;
DROP POLICY IF EXISTS "Group admins can delete members" ON public.savings_group_members;
